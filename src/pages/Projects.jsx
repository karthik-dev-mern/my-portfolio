...
import project from "../assets/projects/memes.png";
import lift from "../assets/projects/bot.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/karthik-dev-mern/chat-bot"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/karthik-dev-mern/Blogger"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/karthik-dev-mern/ecommerce"
            />
          </Col>
